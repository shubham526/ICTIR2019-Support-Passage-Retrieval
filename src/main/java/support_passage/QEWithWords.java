...
/**
 * QE with words from the entity context document.
 * @author Shubham Chatterjee
 * @version 7/22/2019
 */

public class QEWithWords {
    ...
    public QEWithWords(String indexDir, String trecCarDir, String outputDir, String dataDir, String paraRunFile,
                       String entityRunFile, String outFile, String entityQrelPath,int takeKTerms, int takeKDocs,
                       boolean omitQueryTerms, Analyzer analyzer, Similarity similarity) {
...
//        System.out.println("[Done].");
    ...
    private TopDocs getTopDocsForEntity(@NotNull String queryID, ArrayList<Document> documents) throws IOException {
        ///////////////////////////////////////////
    ...
    private void makeRunStrings(String queryId, String entityId, @NotNull TopDocs topDocs) throws IOException {
        ...
        for (int i = 0; i < scoreDocs.length; i++) {
            ...
            runFileString = query + " Q0 " + pID + " " + i + " " + topDocs.scoreDocs[i].score + " " + "feature5";
    ...
    public static void main(@NotNull String[] args) {
        ...
        new QEWithWords(indexDir, trecCarDir, outputDir, dataDir, paraRunFile, entityRunFile, outFile, entityQrel,
